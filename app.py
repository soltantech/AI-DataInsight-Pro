...
# توافق عشان st.experimental_rerun يشتغل على كل النسخ
        ...
        if len(numeric_cols) >= 2:
            ...
            if len(feature_cols) > 0:
                ...
                if r2_score(y_test, y_pred) > 0.7:
                    ...
                    st.warning("⚠ النموذج يحتاج إلى تحسين، جرب إضافة المزيد من المتغيرات أو استخدام نموذج أكثر تعقيدًا.")
            ...
            st.info("ℹ تحتاج إلى عمودين رقميين على الأقل للقيام بالتنبؤ.")

    else:
        st.warning("⚠ لم يتم العثور على أعمدة رقمية في الملف. يرجى رفع ملف يحتوي على بيانات رقمية.")
